/*
 ...
 Source Schema         : bishe_date

 Target Server Type    : MySQL
 Target Server Version : 50728
 File Encoding         : 65001

 Date: 05/12/2023 20:43:01
*/
...
-- Records of bs_class
-- ----------------------------
INSERT INTO `bs_class` VALUES (2, '信管B183');
INSERT INTO `bs_class` VALUES (4, '信管B182');
INSERT INTO `bs_class` VALUES (5, '信管B181');

-- ----------------------------
-- Table structure for bs_competition
-- ----------------------------
DROP TABLE IF EXISTS `bs_competition`;
CREATE TABLE `bs_competition`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `competition_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '比赛名称',
  `competition_creat_time` datetime(0) NOT NULL COMMENT '发布时间',
  `competition_creat_id` bigint(20) NULL DEFAULT NULL COMMENT '比赛创建人id',
  `competition_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '比赛主题',
  `competition_join_end_time` datetime(0) NOT NULL COMMENT '报名截止时间',
  `competition_start_time` datetime(0) NOT NULL COMMENT '比赛时间',
  `competition_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '比赛URL',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '赛事表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bs_competition
-- ----------------------------
INSERT INTO `bs_competition` VALUES (1, '第十三届“挑战杯”中国大学生创业计划竞赛', '2022-04-07 14:55:03', 1, '第十三届“挑战杯”', '2022-04-07 14:55:11', '2022-04-07 14:55:14', 'http://www.52jingsai.com/article-16861-1.html');
INSERT INTO `bs_competition` VALUES (2, '2022年第六届“普译奖”全国大学生翻译比赛', '2022-04-08 20:49:21', 1, '全国大学生翻译比赛', '2022-04-23 00:00:00', '2022-04-06 00:00:00', 'http://www.52jingsai.com/article-16089-1.html');

-- ----------------------------
-- Table structure for bs_evaluation
-- ----------------------------
DROP TABLE IF EXISTS `bs_evaluation`;
CREATE TABLE `bs_evaluation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `evaluation_production_id` bigint(20) NOT NULL COMMENT '评价作品id',
  `evaluation_person_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '评价用户id',
  `evaluation_person_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '评价用户姓名',
  `evaluation_person_type` bigint(20) NOT NULL COMMENT '评价用户类别',
  `evaluation_time` datetime(0) NOT NULL COMMENT '评价时间',
  `evaluation_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '评价内容',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '评价表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bs_evaluation
-- ----------------------------
INSERT INTO `bs_evaluation` VALUES (1, 2163, '39', '高文军', 1, '2022-05-26 11:55:44', '我的作品');
INSERT INTO `bs_evaluation` VALUES (2, 2163, '39', '高文军', 1, '2022-05-26 11:55:56', '创意很好');
INSERT INTO `bs_evaluation` VALUES (3, 2166, '118', '王冠', 1, '2022-06-02 11:53:54', '撒大苏打');
INSERT INTO `bs_evaluation` VALUES (4, 2161, '118', '王冠', 1, '2022-06-07 09:56:08', 'aaaa');

-- ----------------------------
-- Table structure for bs_picture
-- ----------------------------
DROP TABLE IF EXISTS `bs_picture`;
CREATE TABLE `bs_picture`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of bs_picture
-- ----------------------------
INSERT INTO `bs_picture` VALUES (1, '/img/productPic/5832909185359651.jpg', '2022-04-04 19:15:07', 2);

-- ----------------------------
-- Table structure for bs_production
-- ----------------------------
DROP TABLE IF EXISTS `bs_production`;
CREATE TABLE `bs_production`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '作品id',
  `production_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '作品名称',
  `category_id` bigint(20) NOT NULL COMMENT '作品类别id',
  `team_id` bigint(20) NOT NULL COMMENT '团队id——当所属用户类型为1时，为教师id',
  `team_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '团队名称——当所属用户类型为1时，为教师名称',
  `team_type` bigint(20) NOT NULL DEFAULT 0 COMMENT '所属用户类型1学生，2老师',
  `creat_time` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `creat_person_id` bigint(20) NULL DEFAULT NULL COMMENT '创建者id',
  `creat_person_type` bigint(20) NULL DEFAULT NULL COMMENT '创建者类型',
  `update_person_id` bigint(20) NULL DEFAULT NULL COMMENT '修改者id\r\n',
  `update_person_type` bigint(20) NULL DEFAULT NULL COMMENT '修改者类型',
  `update_time` datetime(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  `production_teacher_id` bigint(20) NOT NULL COMMENT '指导教师id',
  `production_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '作品说明',
  `production_video` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '作品视频',
  `production_document` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '作品文档',
  `production_picture_id` bigint(20) NULL DEFAULT NULL COMMENT '作品id,根据id查询图片表',
  `production_title_picture` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '作品封面图片',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2177 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '作品表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bs_production
-- ----------------------------
INSERT INTO `bs_production` VALUES (2159, '三防照明井盖优化', 1, 13, NULL, 1, '2022-05-19 17:27:44', NULL, NULL, NULL, NULL, '2022-05-19 17:27:44', 2, NULL, '/video/1650525071430VID20211209095920.mp4', '/document/1650525066074计算机学院-信息管理与信息系统-信管B182-201807034212-朱子月.doc', NULL, '/img/productPic/1111111.jpg');
INSERT INTO `bs_production` VALUES (2161, '智能服务机器人', 1, 15, NULL, 1, '2022-05-19 17:31:35', NULL, NULL, NULL, NULL, '2022-05-19 17:31:35', 2, NULL, '/video/1650525692873IMG_5945.MOV', '/document/1650525687319计算机学院-信息管理与信息系统-信管B182-201807034215-王艺霖.doc', NULL, '/img/productPic/智能服务机器人.jpg');
INSERT INTO `bs_production` VALUES (2162, '美丽发现', 6, 16, NULL, 1, '2022-05-19 17:32:56', NULL, NULL, NULL, NULL, '2022-05-19 17:32:56', 2, NULL, '/video/1650525858276IMG_6354.MOV', '/document/1650525849895计算机学院-信息管理与信息系统-信管B183-201807034302-卢珊.doc', NULL, '/img/productPic/美丽发现.jpg');
INSERT INTO `bs_production` VALUES (2163, '智慧社区', 1, 17, NULL, 1, '2022-05-19 17:34:09', NULL, NULL, NULL, NULL, '2022-05-19 17:34:09', 2, NULL, '/video/1650525917605QQ视频20211209144634.mp4', '/document/1650525915938计算机学院-信息管理与信息系统-信管B181-201807034102-高文军.doc', NULL, '/img/productPic/智慧社区.png');
INSERT INTO `bs_production` VALUES (2164, '应急管理APP', 1, 18, NULL, 1, '2022-05-19 17:36:08', NULL, NULL, NULL, NULL, '2022-05-19 17:36:08', 2, NULL, '/video/1650526343812QQ视频20211209115528.mp4', '/document/1650526342815计算机学院-信息管理与信息系统-信管B183-201807034315-孙皓偲.doc', NULL, '/img/productPic/应急管理app.png');
INSERT INTO `bs_production` VALUES (2165, '校园二手交易平台', 6, 20, NULL, 1, '2022-05-19 17:37:32', NULL, NULL, NULL, NULL, '2022-05-19 17:37:32', 2, NULL, '/video/1650526480898鏍″洯浜屾墜浜ゆ槗骞冲彴璺紨瑙嗛.mp4', '/document/1650526478526计算机学院-信息管理与信息系统-信管B182-201807034205-靳佳蓉.doc', NULL, '/img/productPic/校园二手交易平台.png');
INSERT INTO `bs_production` VALUES (2166, '高校后勤助手', 1, 21, NULL, 1, '2022-05-19 17:38:52', NULL, NULL, NULL, NULL, '2022-05-19 17:38:52', 2, NULL, '/video/1650526571932VID_20211209_160842.mp4', '/document/1650526569253计算机学院-信息管理与信息系统-信管B183-201807034328-王冠.doc', NULL, '/img/productPic/高校后勤助手.png');
INSERT INTO `bs_production` VALUES (2167, '掌上导游', 1, 22, NULL, 1, '2022-05-19 17:39:39', NULL, NULL, NULL, NULL, '2022-05-19 17:39:39', 2, NULL, '/video/1650526765070IMG_8721.MOV', '/document/1650526763024计算机学院-信息管理与信息系统-信管B183-201807034303-高睿智.doc', NULL, '/img/productPic/掌上导游.png');
INSERT INTO `bs_production` VALUES (2168, '私密行', 1, 23, NULL, 1, '2022-05-19 17:40:27', NULL, NULL, NULL, NULL, '2022-05-19 17:40:27', 2, NULL, '/video/1650526911835IMG_8721.MOV', '/document/1650526909868计算机学院-信息管理与信息系统-信管B183-201807034303-高睿智.doc', NULL, '/img/productPic/私密行.png');
INSERT INTO `bs_production` VALUES (2169, 'vr眼睛', 6, 24, NULL, 1, '2022-05-19 17:42:06', NULL, NULL, NULL, NULL, '2022-05-19 17:42:06', 2, NULL, '/video/1650526979755路演视频-任炘文.MP4', '/document/1650526975765计算机学院-信息管理与信息系统-信管B182-201807034224-王浩森.doc', NULL, '/img/productPic/vr眼睛.png');
INSERT INTO `bs_production` VALUES (2170, '取餐柜', 1, 25, NULL, 1, '2022-05-19 17:42:11', NULL, NULL, NULL, NULL, '2022-05-19 17:42:11', 2, NULL, '/video/165052704901712小组吴雁琼.mp4', '/document/1650527044679计算机学院-信息管理与信息系统-信管B183-201807034311-刘宇佳.doc', NULL, '/img/productPic/取餐柜.png');
INSERT INTO `bs_production` VALUES (2176, 'aaaa', 1, 21, NULL, 1, '2022-06-07 09:55:17', NULL, NULL, NULL, NULL, '2022-06-07 09:55:16', 2, NULL, '/video/16545669158731649077247228kda.mp4', '/document/1654566906138aaa.docx', NULL, '/img/productPic/1654566916888chenyixun.jpg');

-- ----------------------------
-- Table structure for bs_production_category
-- ----------------------------
DROP TABLE IF EXISTS `bs_production_category`;
CREATE TABLE `bs_production_category`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `category_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '作品类别名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '作品类别表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bs_production_category
-- ----------------------------
INSERT INTO `bs_production_category` VALUES (1, '作品类别一');
INSERT INTO `bs_production_category` VALUES (6, '作品类别二');

-- ----------------------------
-- Table structure for bs_production_competition
-- ----------------------------
DROP TABLE IF EXISTS `bs_production_competition`;
CREATE TABLE `bs_production_competition`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `production_id` bigint(20) NOT NULL COMMENT '作品id',
  `competition_id` bigint(20) NOT NULL COMMENT '赛事id',
  `join_time` datetime(0) NOT NULL COMMENT '参赛时间',
  `join_winning` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '获奖情况',
  `production_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '作品评价表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bs_production_competition
-- ----------------------------

-- ----------------------------
-- Table structure for bs_production_score
-- ----------------------------
DROP TABLE IF EXISTS `bs_production_score`;
CREATE TABLE `bs_production_score`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `production_id` bigint(20) NOT NULL COMMENT '作品id',
  `person_id` bigint(20) NOT NULL COMMENT '评分者id',
  `person_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评分者姓名',
  `person_date` datetime(0) NOT NULL COMMENT '评分时间',
  `person_type` int(11) NOT NULL COMMENT '评分者类别',
  `score_type_id` bigint(20) NOT NULL COMMENT '评分类型id',
  `score_type_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评分类型名称',
  `score` bigint(20) NOT NULL COMMENT '得分',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '作品类别评分表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bs
category`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `score_category_id` int(11) NULL DEFAULT NULL COMMENT '评分类别id',
  `production_category_id` int(11) NULL DEFAULT NULL COMMENT '作品类别id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '类别评分表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bs_production_score_category
-- ----------------------------
INSERT INTO `bs_production_score_category` VALUES (5, 1, 1);
INSERT INTO `bs_production_score_category` VALUES (13, 3, 1);
INSERT INTO `bs_production_score_category` VALUES (16, 1, 6);
INSERT INTO `bs_production_score_category` VALUES (18, 4, 6);
INSERT INTO `bs_production_score_category` VALUES (20, 4, 1);

-- ----------------------------
-- Table structure for bs_score_category
-- ----------------------------
DROP TABLE IF EXISTS `bs_score_category`;
CREATE TABLE `bs_score_category`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `score_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评分类别',
  `score_sys` bigint(20) NULL DEFAULT NULL COMMENT '评分制度 100、10',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '评分类别' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bs_score_category
-- ----------------------------
INSERT INTO `bs_score_category` VALUES (1, '创新性', NULL);
INSERT INTO `bs_score_category` VALUES (3, '作品完成度', NULL);
INSERT INTO `bs_score_category` VALUES (4, '作品契合度', NULL);

-- ----------------------------
-- Table structure for bs_stu_team
-- ----------------------------
DROP TABLE IF EXISTS `bs_stu_team`;
CREATE TABLE `bs_stu_team`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of bs_stu_team
-- ----------------------------
INSERT INTO `bs_stu_team` VALUES (31, 1, 1, '大马论怪', NULL);
INSERT INTO `bs_stu_team` VALUES (32, 1, 6, '大马论怪', NULL);
INSERT INTO `bs_stu_team` VALUES (35, 3, 4, '大马论怪', NULL);
INSERT INTO `bs_stu_team` VALUES (36, 11, 6, '大马论怪', NULL);
INSERT INTO `bs_stu_team` VALUES (37, 10, 6, '中文乱码', NULL);
INSERT INTO `bs_stu_team` VALUES (38, 5, 6, '中文乱码', NULL);
INSERT INTO `bs_stu_team` VALUES (39, 4, 6, '乱码', NULL);
INSERT INTO `bs_stu_team` VALUES (40, 3, 6, '2', NULL);
INSERT INTO `bs_stu_team` VALUES (41, 2, 6, 'bbb', NULL);
INSERT INTO `bs_stu_team` VALUES (42, 35, 8, '周奕锦', NULL);
INSERT INTO `bs_stu_team` VALUES (43, 11, 8, '王毓森', NULL);
INSERT INTO `bs_stu_team` VALUES (44, 5, 8, '中文乱码', NULL);
INSERT INTO `bs_stu_team` VALUES (46, 2, 9, '啊啊啊', NULL);
INSERT INTO `bs_stu_team` VALUES (47, 2, 10, '啊啊啊', NULL);
INSERT INTO `bs_stu_team` VALUES (49, 11, 11, '大马论怪', NULL);
INSERT INTO `bs_stu_team` VALUES (52, 10, 12, '中文乱码', NULL);
INSERT INTO `bs_stu_team` VALUES (53, 11, 12, '王毓森', NULL);
INSERT INTO `bs_stu_team` VALUES (54, 1, 12, '大马论怪', NULL);
INSERT INTO `bs_stu_team` VALUES (55, 74, 13, '张子瑶', NULL);
INSERT INTO `bs_stu_team` VALUES (56, 76, 13, '朱子月', NULL);
INSERT INTO `bs_stu_team` VALUES (57, 77, 13, '孙世悦', NULL);
INSERT INTO `bs_stu_team` VALUES (58, 80, 13, '韦庆春', NULL);
INSERT INTO `bs_stu_team` VALUES (59, 42, 14, '蓝光智', NULL);
INSERT INTO `bs_stu_team` VALUES (60, 35, 14, '周奕锦', NULL);
INSERT INTO `bs_stu_team` VALUES (61, 44, 14, '史彦铭', NULL);
INSERT INTO `bs_stu_team` VALUES (62, 48, 14, '刘代勋', NULL);
INSERT INTO `bs_stu_team` VALUES (63, 68, 15, '董浩冉', NULL);
INSERT INTO `bs_stu_team` VALUES (64, 73, 15, '郭浩男', NULL);
INSERT INTO `bs_stu_team` VALUES (65, 78, 15, '王艺霖', NULL);
INSERT INTO `bs_stu_team` VALUES (66, 79, 15, '覃宏荣', NULL);
INSERT INTO `bs_stu_team` VALUES (67, 75, 15, '张鹏', NULL);
INSERT INTO `bs_stu_team` VALUES (68, 71, 15, '张斌', NULL);
INSERT INTO `bs_stu_team` VALUES (69, 95, 16, '卢珊', NULL);
INSERT INTO `bs_stu_team` VALUES (70, 88, 16, '李瑶', NULL);
INSERT INTO `bs_stu_team` VALUES (71, 82, 16, '郭琳', NULL);
INSERT INTO `bs_stu_team` VALUES (72, 50, 17, '王晴', NULL);
INSERT INTO `bs_stu_team` VALUES (73, 66, 17, '罗赵玲', NULL);
INSERT INTO `bs_stu_team` VALUES (74, 39, 17, '高文军', NULL);
INSERT INTO `bs_stu_team` VALUES (75, 40, 17, '樊淑惠', NULL);
INSERT INTO `bs_stu_team` VALUES (76, 41, 17, '符青莲', NULL);
INSERT INTO `bs_stu_team` VALUES (77, 86, 17, '陶志聪', NULL);
INSERT INTO `bs_stu_team` VALUES (78, 110, 19, '张璟尧', NULL);
INSERT INTO `bs_stu_team` VALUES (79, 109, 19, '侯晓宇', NULL);
INSERT INTO `bs_stu_team` VALUES (80, 107, 19, '孙皓偲', NULL);
INSERT INTO `bs_stu_team` VALUES (81, 106, 19, '朱章琪', NULL);
INSERT INTO `bs_stu_team` VALUES (82, 101, 19, '张逸飞', NULL);
INSERT INTO `bs_stu_team` VALUES (83, 99, 19, '张仲千', NULL);
INSERT INTO `bs_stu_team` VALUES (84, 63, 20, '熊佳敏', NULL);
INSERT INTO `bs_stu_team` VALUES (85, 60, 20, '李娜', NULL);
INSERT INTO `bs_stu_team` VALUES (86, 61, 20, '汪文沁', NULL);
INSERT INTO `bs_stu_team` VALUES (87, 55, 20, '左雅茹', NULL);
INSERT INTO `bs_stu_team` VALUES (88, 69, 20, '靳佳蓉', NULL);
INSERT INTO `bs_stu_team` VALUES (89, 43, 20, '张梦茹', NULL);
INSERT INTO `bs_stu_team` VALUES (90, 118, 21, '王冠', NULL);
INSERT INTO `bs_stu_team` VALUES (91, 120, 21, '刘璐', NULL);
INSERT INTO `bs_stu_team` VALUES (92, 115, 21, '张嘉颖', NULL);
INSERT INTO `bs_stu_team` VALUES (93, 96, 22, '高睿智', NULL);
INSERT INTO `bs_stu_team` VALUES (94, 97, 22, '孙煜棋', NULL);
INSERT INTO `bs_stu_team` VALUES (95, 98, 22, '张之禧', NULL);
INSERT INTO `bs_stu_team` VALUES (96, 93, 22, '陶玉霞', NULL);
INSERT INTO `bs_stu_team` VALUES (97, 94, 22, '范俊鑫', NULL);
INSERT INTO `bs_stu_team` VALUES (98, 90, 23, '贾鹏里', NULL);
INSERT INTO `bs_stu_team` VALUES (99, 11, 23, '王毓森', NULL);
INSERT INTO `bs_stu_team` VALUES (100, 52, 23, '张云鹏', NULL);
INSERT INTO `bs_stu_team` VALUES (101, 58, 23, '刘旭鹏', NULL);
INSERT INTO `bs_stu_team` VALUES (102, 87, 24, '王浩森', NULL);
INSERT INTO `bs_stu_team` VALUES (103, 81, 24, '章辰翔', NULL);
INSERT INTO `bs_stu_team` VALUES (104, 51, 24, '方思琦', NULL);
INSERT INTO `bs_stu_team` VALUES (105, 45, 24, '李晓娜', NULL);
INSERT INTO `bs_stu_team` VALUES (106, 85, 24, '任炘文', NULL);
INSERT INTO `bs_stu_team` VALUES (107, 100, 25, '李文娟', NULL);
INSERT INTO `bs_stu_team` VALUES (108, 102, 25, '张紫娟', NULL);
INSERT INTO `bs_stu_team` VALUES (109, 103, 25, '刘宇佳', NULL);
INSERT INTO `bs_stu_team` VALUES (110, 104, 25, '韦迎庆', NULL);
INSERT INTO `bs_stu_team` VALUES (111, 105, 25, '赵若凡', NULL);
INSERT INTO `bs_stu_team` VALUES (112, 108, 25, '吴雁琼', NULL);
INSERT INTO `bs_stu_team` VALUES (113, 55, 26, '左雅茹', NULL);
INSERT INTO `bs_stu_team` VALUES (114, 54, 26, '崔麒升', NULL);
INSERT INTO `bs_stu_team` VALUES (115, 53, 26, '许淳玮', NULL);
INSERT INTO `bs_stu_team` VALUES (116, 56, 26, '胡琨', NULL);
INSERT INTO `bs_stu_team` VALUES (117, 1, 27, '大马论怪', NULL);
...
-- ----------------------------
INSERT INTO `bs_student` VALUES (11, 201607034217, '王毓森', '123456', 4);
INSERT INTO `bs_student` VALUES (35, 201807034101, '周奕锦', '123456', 5);
INSERT INTO `bs_student` VALUES (39, 201807034102, '高文军', '123456', 5);
INSERT INTO `bs_student` VALUES (40, 201807034103, '樊淑惠', '123456', 5);
INSERT INTO `bs_student` VALUES (41, 201807034105, '符青莲', '123456', 5);
INSERT INTO `bs_student` VALUES (42, 201807034107, '蓝光智', '123456', 5);
INSERT INTO `bs_student` VALUES (43, 201807034108, '张梦茹', '123456', 5);
INSERT INTO `bs_student` VALUES (44, 201807034109, '史彦铭', '123456', 5);
INSERT INTO `bs_student` VALUES (45, 201807034110, '李晓娜', '123456', 5);
INSERT INTO `bs_student` VALUES (46, 201807034111, '杨文静', '123456', 5);
INSERT INTO `bs_student` VALUES (47, 201807034112, '黄秀梅', '123456', 5);
INSERT INTO `bs_student` VALUES (48, 201807034113, '刘代勋', '123456', 5);
INSERT INTO `bs_student` VALUES (49, 201807034114, '杨玉萌', '123456', 5);
INSERT INTO `bs_student` VALUES (50, 201807034115, '王晴', '123456', 5);
INSERT INTO `bs_student` VALUES (51, 201807034116, '方思琦', '123456', 5);
INSERT INTO `bs_student` VALUES (52, 201807034117, '张云鹏', '123456', 5);
INSERT INTO `bs_student` VALUES (53, 201807034118, '许淳玮', '123456', 5);
INSERT INTO `bs_student` VALUES (93, 201807034230, '陶玉霞', '123456', 4);
INSERT INTO `bs_student` VALUES (94, 201807034231, '范俊鑫', '123456', 4);
INSERT INTO `bs_student` VALUES (95, 201807034302, '卢珊', '123456', 2);
INSERT INTO `bs_student` VALUES (96, 201807034303, '高睿智', '123456', 2);
INSERT INTO `bs_student` VALUES (97, 201807034304, '孙煜棋', '123456', 2);
INSERT INTO `bs_student` VALUES (98, 201807034305, '张之禧', '123456', 2);
INSERT INTO `bs_student` VALUES (99, 201807034306, '张仲千', '123456', 2);
INSERT INTO `bs_student` VALUES (100, 201807034307, '李文娟', '123456', 2);
INSERT INTO `bs_student` VALUES (101, 201807034308, '张逸飞', '123456', 2);
INSERT INTO `bs_student` VALUES (102, 201807034309, '张紫娟', '123456', 2);
INSERT INTO `bs_student` VALUES (103, 201807034311, '刘宇佳', '123456', 2);
INSERT INTO `bs_student` VALUES (104, 201807034312, '韦迎庆', '123456', 2);
INSERT INTO `bs_student` VALUES (105, 201807034313, '赵若凡', '123456', 2);
INSERT INTO `bs_student` VALUES (106, 201807034314, '朱章琪', '123456', 2);
INSERT INTO `bs_student` VALUES (107, 201807034315, '孙皓偲', '123456', 2);
INSERT INTO `bs_student` VALUES (108, 201807034316, '吴雁琼', '123456', 2);
INSERT INTO `bs_student` VALUES (109, 201807034317, '侯晓宇', '123456', 2);
INSERT INTO `bs_student` VALUES (110, 201807034318, '张璟尧', '123456', 2);
INSERT INTO `bs_student` VALUES (111, 201807034320, '董春媛', '123456', 2);
INSERT INTO `bs_student` VALUES (113, 201807034323, '刘锋', '123456', 2);
INSERT INTO `bs_student` VALUES (114, 201807034324, '李佩', '123456', 2);
INSERT INTO `bs_student` VALUES (115, 201807034325, '张嘉颖', '123456', 2);
INSERT INTO `bs_student` VALUES (116, 201807034326, '杨彩霞', '123456', 2);
INSERT INTO `bs_student` VALUES (117, 201807034327, '崔丽丽', '123456', 2);
INSERT INTO `bs_student` VALUES (118, 201807034328, '王冠', '123456', 2);
INSERT INTO `bs_student` VALUES (119, 201807034329, '张灵颖', '123456', 2);
INSERT INTO `bs_student` VALUES (120, 201807034331, '刘璐', '123456', 2);
INSERT INTO `bs_student` VALUES (121, 201807034321, '陈云超', '123456', 2);
...
-- ----------------------------
INSERT INTO `bs_teacher` VALUES (2, '郭慧', '123', '123');
...
-- Records of bs_team
-- ----------------------------
INSERT INTO `bs_team` VALUES (13, '第一组');
INSERT INTO `bs_team` VALUES (14, '第二组');
INSERT INTO `bs_team` VALUES (15, '第三组');
INSERT INTO `bs_team` VALUES (16, '第四组');
INSERT INTO `bs_team` VALUES (17, '第五组');
INSERT INTO `bs_team` VALUES (18, '第六组');
INSERT INTO `bs_team` VALUES (19, '第六组');
INSERT INTO `bs_team` VALUES (20, '第七组');
INSERT INTO `bs_team` VALUES (21, '第八组');
INSERT INTO `bs_team` VALUES (22, '第九组');
INSERT INTO `bs_team` VALUES (23, '第十组');
INSERT INTO `bs_team` VALUES (24, '第十一组');
INSERT INTO `bs_team` VALUES (25, '第十二组');
INSERT INTO `bs_team` VALUES (26, '第十三组');
